...
class ActionDispatcher:
    ...
    def dispatch(
        ...
        for event in eligible_events:
            calendar_id = self._resolve_calendar_id(analysis.related_profile_ids, profiles)
            logger.debug("Creating event '%s' on calendar %s", event.summary, calendar_id)
    ...
    @staticmethod
    def _resolve_calendar_id(related_ids: list[str], profiles: dict[str, Profile]) -> str:
        """
